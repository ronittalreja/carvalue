...
export default function ComparePage() {
  ...
  useEffect(() => {
    if (!a.company) return
    ;(async () => {
      const res = await fetch(`https://carvalue.onrender.com/models/${encodeURIComponent(a.company)}`)
      const data = await res.json()
  ...
  useEffect(() => {
    if (!b.company) return
    ;(async () => {
      const res = await fetch(`https://carvalue.onrender.com/models/${encodeURIComponent(b.company)}`)
      const data = await res.json()
